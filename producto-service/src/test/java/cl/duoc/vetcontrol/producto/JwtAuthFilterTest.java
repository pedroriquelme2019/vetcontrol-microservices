...
class JwtAuthFilterTest {
    ...
    @Test
    void authorizationNoBearerDebeContinuarSinAutenticar()
            throws Exception {
    ...
    void tokenInvalidoDebeLimpiarContexto()
        ...
        Authentication authenticationAnterior =
    ...
    @Test
    void tokenValidoDebeAutenticarUsuarioConRolAdmin()
            throws Exception {
    ...
    @Test
    void tokenValidoDebeCrearRolVeterinario()
            throws Exception {
