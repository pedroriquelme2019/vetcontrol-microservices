...
public class MascotaController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Mascota> findById(
    ...
    public ResponseEntity<List<Mascota>> findByCliente(
            @PathVariable Long clienteId
    ) {
        return ResponseEntity.ok(
                service.findByCliente(clienteId)
        );
    }

    @GetMapping("/buscar")
    public ResponseEntity<List<Mascota>> search(
